...
>(({ className, inset, children, ...props }, ref) => {
  ...
  const ChevronIcon = <ChevronRight className={cn("ml-auto h-4 w-4", isRTL && "rotate-180")} />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && "pl-8",
      "[dir='rtl']:text-right [dir='rtl']:pl-2 [dir='rtl']:pr-8",
      className
    )}
    {...props}
  />
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span className={cn(
      ...
      "[dir='rtl']:left-auto [dir='rtl']:right-2"
    )}>
